    ...
    },
    {
      ...
      render: row => (
        <div class="flex-center gap-8px">
          <NButton v-permission="'/sysRole/modify/{id}'" type="primary" ghost size="small" onClick={() => edit(row.id)}>
            {$t('common.edit')}
          </NButton>
          <NPopconfirm v-permission="'/sysRole/delete/{id}'" onPositiveClick={() => handleDelete(row.id)}>
            {{
